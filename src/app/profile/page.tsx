        ...
        {activeTab === "launcher" && (
          <div className="space-y-6">
            ...
            <div className="p-6 rounded-xl border border-white/10 bg-white/5">
              ...
              <a href="https://github.com/axa78946-hue/-funik-client-files/releases/download/v1.0.0/FunikLoader.zip" download className="inline-block px-6 py-2.5 bg-blue-600 hover:bg-blue-500 text-white font-medium rounded-lg transition-colors">
                Скачать
              </a>
            </div>
          </div>
